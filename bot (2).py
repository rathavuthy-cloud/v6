...
# ======================================================================
# CONFIG — read from Railway's Variables tab, not hardcoded here.
# Set TELEGRAM_BOT_TOKEN and EODHD_API_KEY as Variables on this service.
# ======================================================================

TELEGRAM_BOT_TOKEN = os.environ.get("TELEGRAM_BOT_TOKEN", "")
EODHD_API_KEY = os.environ.get("EODHD_API_KEY", "")             # https://eodhd.com
XAUUSD_SYMBOL = os.environ.get("XAUUSD_SYMBOL", "XAUUSD.FOREX")  # confirm against EODHD's current symbol list for your plan
DB_PATH = os.environ.get("DB_PATH", "signal_bot.db")

if not TELEGRAM_BOT_TOKEN:
    raise SystemExit(
        "TELEGRAM_BOT_TOKEN is not set. Add it as a Variable on this Railway "
        "service (Variables tab, not in the code) and redeploy."
    )
